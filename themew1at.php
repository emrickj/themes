...
<!-- Sidebar -->
<div class="w3-sidebar w3-light-grey w3-bar-block w3-large w3-collapse w3-card-2"
...
if ($w=="1")
   if(strlen($xml->page[$p-1]->image)>4)
      echo "<img class='w3-image w3-animate-zoom' src='".$xml->page[$p-1]->image."' style='width:100%'>\n";
if ($w=="2")
   if(strlen($xml2->page[$p-1]->image)>4)
      echo "<img class='w3-image w3-animate-zoom' src='".$xml2->page[$p-1]->image."' style='width:100%'>\n";
?>
...
?>
     <form class="w3-container w3-animate-left" role="form" method="post">
     <div class="w3-row">
...
?>
     ...
     <div class="w3-container w3-animate-left" id="HCB_comment_box"><a href="https://www.htmlcommentbox.com">HTML Comment Box</a> is loading comments...</div>
