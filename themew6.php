<?php
   ...
   $page = $xml->xpath("/website/page[name!='' and position()<=3]");
...
<?php
   $i=1;
   foreach ($page as $item) {
	 echo "<div class='w3-container w3-padding-32' id='p".$i++."' lang='".$item['language']."'>";
	 echo "<h3 class='w3-border-bottom w3-border-light-grey w3-padding-16'>".$item->name."</h3>";
