...
<button class="w3-bar-item w3-button w3-large w3-hide-large" onclick="w3_close()">Close &times;</button>
  ...
  for($i=1;$i<=6;$i++) {
    ...
    if(strlen($xml->page[$i-1]->name)>2) 
      echo "<a href='themew1.php?u=".ltrim($b,"_")."&p=".$i."' class='w3-bar-item w3-button".$bs."'>"
    ...
    <div class="w3-dropdown-content w3-bar-block">
      ...
      for($i=1;$i<=6;$i++) {
         ...
         if(strlen($xml2->page[$i-1]->name)>2)
            echo "<a href='themew1.php?u=".ltrim($b,"_")."&w=2&p=".$i."' class='w3-bar-item w3-button w3-cyan".$bs."'>"
